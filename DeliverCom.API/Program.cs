...
namespace DeliverCom.API
{
    internal static class Program
    {
        private static void Main(string[] args)
        {
            ...
            builder.Services.AddDbContext<DeliverComDbContext>(optionsBuilder =>
            {
                optionsBuilder.UseNpgsql(builder.Configuration.GetConnectionString("DeliverComDb"));
            ...
            builder.Host.UseServiceProviderFactory(new AutofacServiceProviderFactory())
                .ConfigureContainer<AutofacContainerBuilder>(container => { container.Bootstrap(); });
